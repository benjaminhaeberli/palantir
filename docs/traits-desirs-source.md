# Traits & Désirs — termes sources (backup)

Sauvegarde des listes anglaises d'origine et de leur traduction française, telles
qu'intégrées dans `src/content/regles/05-caracteristiques.md` (section *Traits & Désirs*).
...
|---|---|
| Brave | Courageux·se |
| Caring | Bienveillant·e |
| Confident | Confiant·e |
| Curious | Curieux·se |
| Gentle | Doux·ce |
| Honest | Honnête |
| Honorable | Honorable |
| Persistent | Persévérant·e |
| Protective | Protecteur·rice |
| Quiet | Silencieux·se |
| Rash | Impulsif·ve |
| Stubborn | Têtu·e |
| Loyal | Loyal·e |
