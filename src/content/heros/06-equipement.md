...
Tous les prix sont exprimés en **pièces (c)**. À titre de repère, 10 c correspondent à une journée de travail non qualifié.

## Raretés

Un objet se trouve plus ou moins facilement selon l'endroit :

- **Commun** — dans n'importe quel hameau ou village. Corde, torche, scie, flèche, carquois, etc. — environ 5 c.
- **Peu commun** — dans les bourgs et les cités. Lanterne, piège à ours, outils spécialisés, etc. — environ 20 c.
- **Rare** — uniquement dans les grandes cités. Sextant, sablier, astrolabe, etc. — 100 c et plus.
...
Volaille 5 c · chien, porc, chèvre 20 c · vache 100 c · faucon dressé 1 000 c.

## Tenues

Une tenue signale votre rang, du plus humble au plus fastueux : pauvre 60 c · modeste 120 c · convenable 240 c · aisée 600 c · petite noblesse 2 400 c · haute noblesse 12 000 c · royale 120 000 c.
